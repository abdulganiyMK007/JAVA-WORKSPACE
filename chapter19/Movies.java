...
public class Movies {
   ...
   public static void main(String[] args) throws IOException {
      ...
      System.out.println(
            mostProlificDirector + " directed " + moviesByDirector.get(mostProlificDirector).size() + " movies:");
   ...
   public static boolean isSorted(List<String> names) {
      List<String> lastNames = names.stream().map(n -> n.substring(n.lastIndexOf(" ") + 1))
            .collect(Collectors.toList());
